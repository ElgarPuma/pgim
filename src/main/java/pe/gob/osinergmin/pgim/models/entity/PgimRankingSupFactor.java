...
/**
* Clase Entidad para la tabla PGIM_TD_RANKING_SUP_FACTOR: 
...
*/
@Entity
@Table(name = "PGIM_TD_RANKING_SUP_FACTOR")
@Data
@NoArgsConstructor
public class PgimRankingSupFactor implements Serializable{
...
private static final long serialVersionUID = 1L;
  ...
  */
   ...
   @Column(name = "ID_RANKING_SUP_FACTOR", nullable = false)
  ...
  */
   ...
   @JoinColumn(name = "ID_RANKING_SUP_GRUPO", nullable = false)
  private PgimRankingSupGrupo pgimRankingSupGrupo;
  ...
  */
  ...
  private PgimNivelRiesgo nivelRiesgoFactor;
