...
/**
* Clase Entidad para la tabla PGIM_TM_SUSTANCIA: 
* @descripción: Sustancia como tipo que se asocia a las unidades mineras
*
* @author: hdiaz
* @version 1.0
...
*/
@Entity
@Table(name = "PGIM_TM_SUSTANCIA")
@Data
@NoArgsConstructor
public class PgimSustancia implements Serializable{
...
private static final long serialVersionUID = 1L;
  ...
  */
   @Id
   @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PGIM_SEQ_SUSTANCIA")
   @SequenceGenerator(name = "PGIM_SEQ_SUSTANCIA", sequenceName = "PGIM_SEQ_SUSTANCIA", allocationSize = 1)
   @Column(name = "ID_SUSTANCIA", nullable = false)
  ...
  */
   ...
   @JoinColumn(name = "ID_TIPO_SUSTANCIA", nullable = false)
  private PgimValorParametro tipoSustancia;

  /*
  *Nombre del método de explotación
  */
   @Column(name = "NO_SUSTANCIA", nullable = false)
  private String noSustancia;
