 ...
 */
@Entity
@Table(name = "MV_OSIN_MINERAL_RECIB_PLA", schema = "ES_PGIM_ESTAMIN")
@Data
@NoArgsConstructor
public class PgimMineralRecibPlantaAux implements Serializable {

    private static final long serialVersionUID = 1L;
    
    /*
     * ID_CLIENTE
     * Identificador interno de la vista MV_OSIN_MINERAL_RECIB_PLA. Secuencia:
     * MV_OSIN_MINERAL_RECIB_PLA
     */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "MV_OSIN_MINERAL_RECIB_PLA")
    @SequenceGenerator(name = "MV_OSIN_MINERAL_RECIB_PLA", sequenceName = "MV_OSIN_MINERAL_RECIB_PLA", allocationSize = 1)
     ...
     * OBTENIDO_DE
     */
    @Column(name = "OBTENIDO_DE", nullable = true)
    private String obtenidoDe;

    /*
     * UNIDAD_OBTENIDO
     */
    @Column(name = "UNIDAD_OBTENIDO", nullable = true)
    private String unidadObtenido;

    /*
     * RUC_PROVEEDOR
     */
    @Column(name = "RUC_PROVEEDOR", nullable = true)
     ...
     * CANTIDAD_PROCESADA
     */
    @Column(name = "CANTIDAD_PROCESADA", nullable = true)
