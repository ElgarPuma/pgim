...
/**
* Clase Entidad para la tabla PGIM_TM_RELACION_ENTREGABLE: 
* @descripción: Relación del paso y tipo de entregable
*
* @author: hdiaz
* @version 1.0
...
*/
@Entity
@Table(name = "PGIM_TM_RELACION_ENTREGABLE")
@Data
@NoArgsConstructor
public class PgimRelacionEntregable implements Serializable{

private static final long serialVersionUID = 1L;

  /*
  *Identificador interno de la relación del paso del proceso. Secuencia: PGIM_SEQ_RELACION_ENTREGABLE
  */
   @Id
   @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PGIM_SEQ_RELACION_ENTREGABLE")
   @SequenceGenerator(name = "PGIM_SEQ_RELACION_ENTREGABLE", sequenceName = "PGIM_SEQ_RELACION_ENTREGABLE", allocationSize = 1)
   @Column(name = "ID_RELACION_ENTREGABLE", nullable = false)
  private Long idRelacionEntregable;
