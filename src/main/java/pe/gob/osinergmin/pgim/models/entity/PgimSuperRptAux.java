...
/**
* Clase Entidad para la tabla PGIM_VW_SUPER_RPT_AUX: 
...
*/
@Entity
@Table(name = "PGIM_VW_SUPER_RPT_AUX")
@Data
@NoArgsConstructor
public class PgimSuperRptAux implements Serializable{
...
private static final long serialVersionUID = 1L;
  ...
  */
   @Id
   @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PGIM_SEQ_ID_SUPERVISION_AUX")
   @SequenceGenerator(name = "PGIM_SEQ_ID_SUPERVISION_AUX", sequenceName = "PGIM_SEQ_ID_SUPERVISION_AUX", allocationSize = 1)
