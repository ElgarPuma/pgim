...
/**
* Clase Entidad para la tabla PGIM_VW_INC_PELIGROSO_AUX: 
* @descripción: Vista para obtener la lista de los incidentes peligrosos
*
* @author: hdiaz
* @version 1.0
...
*/
@Entity
@Table(name = "PGIM_VW_INC_PELIGROSO_AUX")
@Data
@NoArgsConstructor
public class PgimIncPeligrosoAux implements Serializable{
